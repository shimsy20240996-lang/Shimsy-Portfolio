                ...
                >
                  ...
                  <div className="space-y-8">
                    {portfolioData.education.map((edu) => (
                      <div key={edu.id} className="relative pl-8 before:absolute before:left-0 before:top-2 before:w-3 before:h-3 before:bg-accent before:rounded-full before:shadow-[0_0_10px_rgba(168,85,247,0.5)] after:absolute after:left-[5px] after:top-5 after:w-0.5 after:h-full after:bg-white/10 last:after:hidden">
