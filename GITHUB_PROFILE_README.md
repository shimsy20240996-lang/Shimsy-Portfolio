<!-- 
  Hi there! To use this on your GitHub profile:
  1. Create a new repository on GitHub with the exact same name as your username: "shimsy20240996-lang"
  2. Initialize it with a README.md file.
  3. Copy and paste the contents of this file into that README.md.
  4. Don't forget to update the placeholder links (email, LinkedIn, portfolio) in the "Social Links" section!
-->
